  ...
  head: () => ({
    meta: [
      ...
      { name: "viewport", content: "width=device-width, initial-scale=1" },
      {
        ...
        content:
          "default-src 'self'; img-src 'self' data: https:; script-src 'self' 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline' https:; font-src 'self' data: https:; connect-src 'self' https:;",
      },
      ...
      { title: "Sumanth — Applied AI Engineer" },
      {
        name: "description",
        content:
          "Sumanth is an Applied AI Engineer building production-grade RAG pipelines, autonomous agents, and evaluated LLM applications.",
      },
      { property: "og:title", content: "Sumanth — Applied AI Engineer" },
      {
        property: "og:description",
        content:
          "Production-grade AI systems: RAG pipelines, autonomous agents, evaluated LLM applications.",
      },
